...
import {initialize, possibleFinalStates, stateChange} from "./mutexAlgorithm.js"
...
// NC constructor
export default class TM extends RunestoneBase {
    constructor(opts) {
        super(opts);
...
$(document).on("runestone:login-complete", function () {
    $("[data-component=threading_mutex]").each(function (index) {
        var opts = {
            orig: this,
