$.i18n().load({
    en: {
        ...
        msg_hint_and: "<br>You may refer to Dive Into Systems <a href = 'https://diveintosystems.org/book/C4-Binary/bitwise.html#_bitwise_AND' target = '_blank'>4.6.1</a>.",
        msg_hint_or: "<br>You may refer to Dive Into Systems <a href = 'https://diveintosystems.org/book/C4-Binary/bitwise.html#_bitwise_OR' target = '_blank'>4.6.2</a>.",
        ...
        msg_incorrect_not_enough: "There are other operator(s) that could generate this result.",
        msg_incorrect_too_many: "You have selected too many operators, some of them cannot generate this result.",
