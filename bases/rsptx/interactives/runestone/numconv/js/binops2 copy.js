...
export default class BO extends RunestoneBase {
   ...
   renderNCPromptAndInput() {
       ...
       this.promptDivTextNode.style.textAlign = "right";
       this.promptDivTextNode2 = document.createElement("code");
       this.promptDivTextNode2.style.textAlign = "right";
   ...
   generatePrompt() {
        ...
        switch(this.menuNode1.value) {
            ...
            case "XOR" :
                ...
                break;
            case "NOT" :
                this.promptDivTextNode.textContent = " NOT(~) " + "0b" +  this.displayed_num_string + " = ";
                break;
            case "Left Shift" :
