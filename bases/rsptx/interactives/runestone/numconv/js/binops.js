...
export default class BO extends RunestoneBase {
   ...
   renderNCPromptAndInput() {
       ...
       this.statementNode05 = document.createTextNode("Please do the bitwise operation based on the chosen operator.");
           ...
           case "XOR" :
            ...
            case "Right Shift(Arithmetic)" :
                ...
                if (this.toBinary(this.target_num)[0] === "1"){
                    // this.target_num_string = this.toBinary(((((~this.target_num) & ((1 << this.num_bits)-1))) | this.target_num) >> this.num_shift);
   ...
   generatePrompt() {
       ...
       switch(this.menuNode1.value) {
           case "AND" :
               this.promptDivTextNode.textContent = "0b" + this.displayed_num_string + " AND(&) " + "0b" + this.displayed_num_string2 + " = " + this.target_num_string + " ";
               break;
           case "OR" :
               this.promptDivTextNode.textContent = "0b" + this.displayed_num_string + " OR(|) " + "0b" + this.displayed_num_string2 + " = " + this.target_num_string + " ";
               break;
           case "XOR" :
               this.promptDivTextNode.textContent = "0b" + this.displayed_num_string + " XOR(^) " + "0b" + this.displayed_num_string2 + " = " + this.target_num_string + " ";
               break;
           case "NOT" :
               this.promptDivTextNode.textContent = " NOT(~) " + "0b" +  this.displayed_num_string + " = " + this.target_num_string + " ";
               break; 
           case "Left Shift" :
                this.promptDivTextNode.textContent = "0b" + this.displayed_num_string + " << " + this.num_shift.toString() +  " = " + this.target_num_string + " ";
                break;
           case "Right Shift(Arithmetic)" :
            this.promptDivTextNode.textContent = "0b" + this.displayed_num_string + " >> " + this.num_shift.toString() +  " = " + this.target_num_string + " ";
                break;
