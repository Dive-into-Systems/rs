$.i18n().load({
    en: {
        ...
        msg_VO_two02dec: "Signed binary can only convert with decimal.",
        msg_VO_not_divisible_by_4: "Error: number of bits should be multiple of 4",
        msg_VO_too_many_bits: "Error: too many number of bits",
        msg_VO_wrong_pf: "Page fault is related to accessing RAM.", 
        msg_VO_wrong_cm: "Cache miss is related to accessing cache.", 
        msg_VO_wrong_db: "Dirty bit is related to writing into memory.",
