...
export default class ASMState_EXCERCISE extends RunestoneBase {
    ...
    validateAnswers(userRegisters, userMemory, step) {
        ...
        console.log("pre execution correct");
        ...
        console.log("post execution correct");
        console.log(isCorrect);
        return isCorrect;
    }
    
    checkAnswer(step) {
        console.log("Checking answers for step: ", step);
        ...
        const isCorrect = this.validateAnswers(userRegisters, userMemory, step);
    ...
    renderInstructionsList(instructions) {
        ...
        instructions.forEach((inst, index) => {
            ...
            const checkButton = $("<button>").text("Check Answer").on("click", () => this.checkAnswer(index));
