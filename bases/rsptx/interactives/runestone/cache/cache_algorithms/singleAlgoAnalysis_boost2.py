...
conflict_chance = [[1/3,1/3], [1/2,1/4], [1/3, 1/4]]
num_reps = 500
        ...
        for chance_conf, conf_incr in conflict_chance:
            ...
            for i in range(len(tagIndexOffset)):
                ...
                for i in range(num_reps):
                    ...
                    currAlgo = main_boost2(ads_num, offset_bits, index_bits, tag_bits, chance_hit, hit_incr, chance_conf, conf_incr)
