...
def generateTagNIndexList(ads_num, tag_bits, index_bits, tag_list, index_list, numUniqueTag, numUniqueIndex):
...
def main_bound2(ads_num, offset_bits, index_bits, tag_bits, numUniqueTag = 1, numUniqueIndex = 1):
    ...
    for i in range(ads_num):
        generateTagNIndexList(ads_num, tag_bits, index_bits, tag_list, index_list, numUniqueTag, numUniqueIndex)
